...
class ImageMulti(models.Model) :
    ...
    image5 = models.ImageField(upload_to='cardnews/%Y/%m/%d', null=True)
    image6 = models.ImageField(upload_to='cardnews/%Y/%m/%d', null=True)
    image7 = models.ImageField(upload_to='cardnews/%Y/%m/%d', null=True)
    image8 = models.ImageField(upload_to='cardnews/%Y/%m/%d', null=True)
    image9 = models.ImageField(upload_to='cardnews/%Y/%m/%d', null=True)
